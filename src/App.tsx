    ...
    >
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <Input id="email" type="email" placeholder="이메일 입력" className="flex-grow" />
          <span>@</span>
          <Input id="domain" type="text" placeholder="도메인 입력" className="w-32" />
          <Button
            size={BtnSize.l}
            text="인증번호 요청"
            type={BtnType.popup}
            onClick={handleRequestVerification}
            className="transform -translate-y-[-6px]" // Tailwind CSS를 사용한 위치 조정
          />
        </div>
        ...
        <Input id="verificationCode" type="text" placeholder="인증번호 입력" />
