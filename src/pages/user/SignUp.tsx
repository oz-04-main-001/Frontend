...
const SignUp: React.FC = () => {
  ...
  const validatePassword = (value: string) => {
    ...
    const hasNoSequentialNumbers = !/(012|123|234|345|456|567|678|789)/.test(value); // 연속 숫자 금지
  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-[500px] bg-gray-50 rounded-md shadow-lg">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}> {/* onSubmit 핸들러 추가 */}
        <div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <Button
              size={BtnSize.l}
              text="남자"
              type={selectedGender === '남자' ? BtnType.primary : BtnType.normal}
              className="w-1/2"
            ...
            <Button
              size={BtnSize.l}
              text="여자"
              type={selectedGender === '여자' ? BtnType.primary : BtnType.normal}
              className="w-1/2"
